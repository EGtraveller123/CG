...
public interface HoudaobuMapper {
    ...
    @Insert("insert into houdaobu(caijianbuid,kuanhao,yanse,xxs,xs,s,m,l,xl,xxl,xxxl,hdbshuliang) values (#{caijianbuid},#{kuanhao},#{yanse},#{xxs},#{xs},#{s},#{m},#{l},#{xl},#{xxl},#{xxxl},#{hdbshuliang})")
    boolean insertHoudaobu(Houdaobu houdaobu);

    @Select("select * from houdaobu where caijianbuid=#{id}")
    Houdaobu selectByid(Integer id);

    @Update("update houdaobu set xxs=#{xxs},xs=#{xs},s=#{s},m=#{m},l=#{l},xl=#{xl},xxl=#{xxl},xxxl=#{xxxl},hdbshuliang=#{hdbshuliang} where caijianbuid=#{caijianbuid}")
    ...
    @Select("select id,kuanhao,yanse,xxs,xs,s,m,l,xl,xxl,xxxl,hdbshuliang from houdaobu where kuanhao=#{kuanhao} and yanse=#{yanse}")
    ...
    @Update("update houdaobu set kuanhao=#{kuanhao},yanse=#{yanse},xxs=#{xxs},xs=#{xs},s=#{s},m=#{m},l=#{l},xl=#{xl},xxl=#{xxl},xxxl=#{xxxl},hdbshuliang=#{hdbshuliang} where kuanhao=#{kuanhao} and yanse=#{yanse}")
